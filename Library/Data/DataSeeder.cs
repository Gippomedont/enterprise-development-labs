...
public static class DataSeeder
{
    ...
    [
        new() { InventoryNumber = 1, CatalogCode = "A123", Authors = "И.И. Иванов", Title = "Основы SQL", PublicationType = "Учебное пособие", PublicationPlace = "Москва", PublicationYear = 2020 },
        new() { InventoryNumber = 2, CatalogCode = "B456", Authors = "П.П. Петров", Title = "Базы данных", PublicationType = "Монография", PublicationPlace = "Санкт-Петербург", PublicationYear = 2019 },
        new() { InventoryNumber = 3, CatalogCode = "C789", Authors = "С.С. Сидоров", Title = "Алгоритмы и структуры данных", PublicationType = "Учебное пособие", PublicationPlace = "Новосибирск", PublicationYear = 2021 },
        new() { InventoryNumber = 4, CatalogCode = "D012", Authors = "А.А. Андреев", Title = "Математический анализ", PublicationType = "Монография", PublicationPlace = "Екатеринбург", PublicationYear = 2018 },
        new() { InventoryNumber = 5, CatalogCode = "E345", Authors = "В.В. Васильев", Title = "Физика", PublicationType = "Учебное пособие", PublicationPlace = "Казань", PublicationYear = 2022 },
        new() { InventoryNumber = 6, CatalogCode = "F678", Authors = "Д.Д. Дмитриев", Title = "Химия", PublicationType = "Методические указания", PublicationPlace = "Ростов-на-Дону", PublicationYear = 2020 },
        new() { InventoryNumber = 7, CatalogCode = "G901", Authors = "Е.Е. Егоров", Title = "Биология", PublicationType = "Учебное пособие", PublicationPlace = "Владивосток", PublicationYear = 2021 }
    ];
